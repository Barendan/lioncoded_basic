...
(function() {
	...
	function init() {
		let showMenu = document.getElementById( 'showMenu' ),
			menuLink = document.querySelector( '.outer-nav' ),
		...
		container.addEventListener( clickevent, function( ev ) {
			// Remove this line of code to fix transform bug
		...
		menuLink.addEventListener( clickevent, function( ev ) {
			ev.preventDefault();
			let hashLink = ev.target.hash;
			let formatLink = hashLink.substr(1, hashLink.length - 1);
			...
			if( classie.has( perspectiveWrapper, 'animate') ) {
				...
				// $('html, body').animate({
					// scrollTop: $(hashLink).offset().top + 900 projects
					// scrollTop: $(hashLink).offset().top + 200
					// scrollTop: $('div.contact_container').scrollIntoView()
				// }, 2000);
				// console.log("give me top:", $("#projects").offset())

				window.setTimeout( function() {
					console.log('fired')
					document.getElementById(formatLink).scrollIntoView()
					// $('.contact_section').scrollTop(500)
					// $("div.bottom_right").scrollTop(100);
				}, 1000)
			}
		});

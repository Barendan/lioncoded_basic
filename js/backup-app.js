$(window).on("load", function() {
	...
	function mobileAnimation() {
		...
		TweenMax.to(scene_5, .1, {scaleY: "0.7"})
		// TweenMax.to(scene_6, .1, {y: "50%"})
		...
		function doStart() {
			...
			doStartTL
				// Exit Scene
				.to(welcome, 10, { opacity: 0, ease: Power1.easeOut }, 1)
				.to(scene_2, 5, {y: "-50%", ease: Power0.easeIn}, 3)
				.to(scene_3, 5, {y: "-20%", ease: Power0.easeIn}, 3)
				...
				.to(scene_5, 7, {x: "-10%", scaleY: "0.7"}, 4)
				.to('.arrow', 3, {top: "25%"}, 6)
				.to(scene_container, 4, {y: "-25%", scale: 0.5, ease: Circ.easeIn}, 4)

				// Enter DoWhat: Part1
				.to(doWhat, 4, { opacity: 1, ease: Power0.easeIn }, 4)
				.to(doWhat, 4, { scale: 1, ease: Circ.easeIn }, 4)
				.to(container_1, 5, {opacity: 1, ease: Power1.easeIn}, 4)
				
				.fromTo(container_1, 5, {y: "70%"}, {y: "-5%", ease: Power1.easeIn}, 2.5)
				.fromTo(br_cont1, 6, {y: "100%"}, {y: "0%"}, 3)
				.fromTo(br_cont1, 6, {opacity: 0 }, {opacity: 1, ease: Power3.easeInOut}, 3)
				.fromTo(br_cont1_text, 7, {y: "100%"}, {y: "0%"}, 4)
			;
